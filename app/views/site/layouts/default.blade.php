		...
		<div id="wrap">
		    ...
		    <footer id="footer" class="navbar navbar-default navbar-static-bottom">
		      ...
		      <div class="container">
		      	...
		      	<p class="pull-right">
		      			<a href="https://www.facebook.com/pages/XDocker/687711791303636"><img width="75px" height="75px" src="{{{ asset('assets/img/facebook.png') }}}" alt="{{{ Lang::get('site.footertitle') }}}"/></a>
		      	</p>
		        <p class="text-center">
