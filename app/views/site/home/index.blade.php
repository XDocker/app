...
<section id="services">
	<div class="container">
		...
		<div class="row text-center">
			...
			<ul class="rslides transparent-btns transparent-btns2" id="slider">
				<li class=""  id="transparent-btns2_s0"><img src="{{asset('assets/img/img0.png')}}" alt="" style="height: 360px;">
				</li>
				<li class=""  id="transparent-btns2_s1"><img src="{{asset('assets/img/img1.png')}}" alt="" style="height: 360px;">
				</li>
				<li class=""  id="transparent-btns2_s2"><img src="{{asset('assets/img/img2.jpeg')}}" alt="" style="height: 360px;">
				</li>
			</ul>
		</div>
	</div>
	...
	<div class="text-center">
		...
		<p>
			<h4><font color="3399FF">Ready to be deployed now on Amazon AWS</font></h4>
		</p>
	</div>
	...
	<div id="slider1_container" style="position: relative; top: 0px; center: 0px; width: 980px; height: 100px; overflow: hidden; ">
		...
		<div u="slides" style="cursor: move; position: absolute; center: 0px; top: 0px; width: 980px; height: 100px; overflow: hidden;">
			...
			<div><img u="image" title="{{ $instance -> name }} : {{ $instance -> description }}" alt="{{ $instance -> name }} : {{ $instance -> description }}" src="{{ asset('/assets/img/providers/'.xDockerEngine::getLogo($instance -> name)) }}" />
			</div>
			@endif
			@endforeach
...
<section id="Customers" class="section section-center section-hilite section-features loaded" style="margin-top:-40px;background-color:transparent;">
	<div class="container" style="padding-right: 40px;">
		<h4 class="text-center"><span style="background-color:transparent;">Our Delighted Customers Using xDock</span></h4>
		<div class="row" style="margin-top:5em;">

			<div id="slider2_container" style="position: relative; top: 0px; center: 0px; width: 1024px; height: 100px; overflow: hidden; ">
				...
				<!-- Slides Container -->
				<div u="slides" style="cursor: move; position: absolute; center: 0px; top: 0px; width: 1024px; height: 60px; overflow: hidden;">

					<div><img u="image" title="olacabs.com" alt="olacabs.com" src="{{asset('assets/img/customers/olacabs.png')}}" />
					</div>
					<div><img u="image" title="loyal3.com" alt="loyal3.com" src="{{asset('assets/img/customers/loyal3.png')}}" />
					</div>
					<div><img u="image" title="sleepnumber.com" alt="sleepnumber.com" src="{{asset('assets/img/customers/selectcomfort.png')}}" />
					</div>
