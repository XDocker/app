<footer id="footer" class="navbar navbar-default navbar-static-bottom">
	...
	<div class="container">
		...
		<p class="pull-right">
		    ...
		    <a href="https://www.linkedin.com/groups/Xdocker-Users-6789160?gid=6789160"><img width="32px" height="32px" src="{{{ asset('assets/img/providerss/LinkedIn.png') }}}" alt="{{{ Lang::get('site.footertitle') }}}"/></a>
