									...
									if(in_array($deployment->status, array('Completed', 'start', 'stop')))
										{
											...
											echo $result->instance_id .xDockerEngine::getDockerUrl($deployment->docker_name) . ' | ' .$anchor . ' | '  .xDockerEngine::documentationUrl($deployment->docker_name) .' | <a class="glyphicon glyphicon-envelope" href="mailto:info@xervmon.com">Manage this Instance?</a>';
