...
class DeploymentController extends BaseController {
    ...
    public function getIndex() {
        ...
        $deployments = $this->deployments
            ->select('deployments.id as deploymentId, cloud_accounts.name as accountName', 'cloud_accounts.cloudProvider', 'deployments.name', 'deployments.cloud_account_id', 'deployments.created_at')
