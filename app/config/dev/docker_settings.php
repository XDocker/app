...
return array(
   ...
   'xdocker/netflix_ice' => array('displayName' => 'Netflix ICE',
    ...
    'xdocker/sketchy' => array('displayName' => 'Netflix Sketchy',
   	 ...
   	 'xdocker/edda' => array('displayName' => 'Netflix Edda',
   								  'docker_url' => 'https://registry.hub.docker.com/u/xdocker/edda/', 
   								  'sgPorts' => array(80, 443),
   								  'dockerParams' => array('ports' => array(80, 443),
   								  					    'tag' => 'v1',
   								  					    'env' => array('host' => '{host}',
												     				   ...
												     				   'AWS_SECRET_ACCESS_KEY' => '{AWS_SECRET_ACCESS_KEY}',
												      				   'cmd' => ''),),
   								  					 'ipUI' => '104.131.14.172',
   								  'logo' => 'edda.png', 'protocol' => 'https://',  
   								  'append' => '',
   								  'securityPolicy' =>  '',
   								  'documentationUrl' => 'https://github.com/Netflix/edda/wiki',
   								  'enabled' => TRUE, 'billingBucket' => FALSE,  'appCredEnabled' => TRUE),
